# Beyond Alignment and Control: Is Goal and Purpose Formation the Upstream AGI Safety Problem?
...
## 9. Questions for the alignment community

The most useful response to this post is not endorsement. It is a model, result, counterexample, or distinction that changes one of the links above.
